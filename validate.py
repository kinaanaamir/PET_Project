...
if __name__ == "__main__":
    ...
    correct, total = test(attack_train_loader, attack_model, path="./model_weights/mnist_net_attack_model.pth",
                          print_statement="test")
    a, b = test(attack_test_loader, attack_model, path="./model_weights/mnist_net_attack_model.pth",
                print_statement="test")
    correct += a
    total += b
